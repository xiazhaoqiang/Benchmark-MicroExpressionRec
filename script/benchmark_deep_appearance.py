...
def arg_process():
    ...
    parser.add_argument('--modelname', default='CNNLSTM', help='the model architecture')
...
def main():
    ...
    for subject in subjects:
        ...
        image_db_train = Datasets.MEDB_ADM(imgList=imgDir, transform=data_transforms)
        ...
        image_db_test = Datasets.MEDB_ADM(imgList=imgDir, transform=data_transforms)
